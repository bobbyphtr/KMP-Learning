...
- (instancetype)initWithRepository:(SharedArticlesRepository *)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) NSString *sourceCountry __attribute__((swift_name("sourceCountry")));
@property (readonly) NSString *sourceDescription __attribute__((swift_name("sourceDescription")));
@property (readonly) NSString *sourceLanguage __attribute__((swift_name("sourceLanguage")));
@property (readonly) NSString *sourceName __attribute__((swift_name("sourceName")));
- (instancetype)initWithSourceName:(NSString *)sourceName sourceDescription:(NSString *)sourceDescription sourceLanguage:(NSString *)sourceLanguage sourceCountry:(NSString *)sourceCountry __attribute__((swift_name("init(sourceName:sourceDescription:sourceLanguage:sourceCountry:)"))) __attribute__((objc_designated_initializer));
- (SharedSource *)doCopySourceName:(NSString *)sourceName sourceDescription:(NSString *)sourceDescription sourceLanguage:(NSString *)sourceLanguage sourceCountry:(NSString *)sourceCountry __attribute__((swift_name("doCopy(sourceName:sourceDescription:sourceLanguage:sourceCountry:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) SharedSourcesRepository *repository __attribute__((swift_name("repository")));
- (instancetype)initWithRepository:(SharedSourcesRepository *)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchSourcesWithCompletionHandler:(void (^)(NSArray<SharedSource *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchSources(completionHandler:)")));
@end
...
- (instancetype)initWithIsLoading:(BOOL)isLoading sources:(NSArray<SharedSource *> *)sources error:(NSString * _Nullable)error __attribute__((swift_name("init(isLoading:sources:error:)"))) __attribute__((objc_designated_initializer));
- (SharedSourcesState *)doCopyIsLoading:(BOOL)isLoading sources:(NSArray<SharedSource *> *)sources error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(isLoading:sources:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> sourceState __attribute__((swift_name("sourceState")));
@property (readonly) SharedSourcesUseCase *useCase __attribute__((swift_name("useCase")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)getSourcesForceFetch:(BOOL)forceFetch __attribute__((swift_name("getSources(forceFetch:)")));
@end

__attribute__((swift_name("SourcesLocalDataSource")))
@protocol SharedSourcesLocalDataSource
@required
- (void)clearAllSources __attribute__((swift_name("clearAllSources()")));
- (NSArray<SharedSourcesRaw *> *)fetchSources __attribute__((swift_name("fetchSources()")));
- (void)insertSourcesSources:(NSArray<SharedSourcesRaw *> *)sources __attribute__((swift_name("insertSources(sources:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SourcesLocalDataSourceImpl")))
@interface SharedSourcesLocalDataSourceImpl : SharedBase <SharedSourcesLocalDataSource>
- (instancetype)initWithDatabase:(id<SharedDailyPulseDatabase>)database __attribute__((swift_name("init(database:)"))) __attribute__((objc_designated_initializer));
- (void)clearAllSources __attribute__((swift_name("clearAllSources()")));
- (NSArray<SharedSourcesRaw *> *)fetchSources __attribute__((swift_name("fetchSources()")));
- (void)insertSourcesSources:(NSArray<SharedSourcesRaw *> *)sources __attribute__((swift_name("insertSources(sources:)")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SourcesRaw")))
@interface SharedSourcesRaw : SharedBase
@property (class, readonly, getter=companion) SharedSourcesRawCompanion *companion __attribute__((swift_name("companion")));
...
- (instancetype)initWithId:(NSString *)id name:(NSString *)name description:(NSString *)description url:(NSString *)url category:(NSString *)category language:(NSString *)language country:(NSString *)country __attribute__((swift_name("init(id:name:description:url:category:language:country:)"))) __attribute__((objc_designated_initializer));
- (SharedSourcesRaw *)doCopyId:(NSString *)id name:(NSString *)name description:(NSString *)description url:(NSString *)url category:(NSString *)category language:(NSString *)language country:(NSString *)country __attribute__((swift_name("doCopy(id:name:description:url:category:language:country:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SourcesRaw.Companion")))
@interface SharedSourcesRawCompanion : SharedBase
@property (class, readonly, getter=shared) SharedSourcesRawCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@property (readonly) id<SharedSourcesLocalDataSource> sourcesLocalDataSource __attribute__((swift_name("sourcesLocalDataSource")));
@property (readonly) SharedSourcesService *sourcesService __attribute__((swift_name("sourcesService")));
- (instancetype)initWithSourcesLocalDataSource:(id<SharedSourcesLocalDataSource>)sourcesLocalDataSource sourcesService:(SharedSourcesService *)sourcesService __attribute__((swift_name("init(sourcesLocalDataSource:sourcesService:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAllSourcesWithCompletionHandler:(void (^)(NSArray<SharedSourcesRaw *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getAllSources(completionHandler:)")));
@end
...
@property (readonly) NSArray<SharedSourcesRaw *> *sources __attribute__((swift_name("sources")));
@property (readonly) NSString *status __attribute__((swift_name("status")));
- (instancetype)initWithStatus:(NSString *)status sources:(NSArray<SharedSourcesRaw *> *)sources __attribute__((swift_name("init(status:sources:)"))) __attribute__((objc_designated_initializer));
- (SharedSourcesResponse *)doCopyStatus:(NSString *)status sources:(NSArray<SharedSourcesRaw *> *)sources __attribute__((swift_name("doCopy(status:sources:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchSourcesWithCompletionHandler:(void (^)(NSArray<SharedSourcesRaw *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchSources(completionHandler:)")));
@end
...
- (void)insertSourceId:(NSString *)id name:(NSString *)name desc:(NSString *)desc url:(NSString *)url category:(NSString *)category language:(NSString *)language country:(NSString *)country __attribute__((swift_name("insertSource(id:name:desc:url:category:language:country:)")));
...
- (SharedRuntimeQuery<SharedSource_ *> *)selectAllSource __attribute__((swift_name("selectAllSource()")));
- (SharedRuntimeQuery<id> *)selectAllSourceMapper:(id (^)(NSString *, NSString *, NSString *, NSString *, NSString *, NSString *, NSString *))mapper __attribute__((swift_name("selectAllSource(mapper:)")));
@end
...
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) NSString *url __attribute__((swift_name("url")));
- (instancetype)initWithId:(NSString *)id name:(NSString *)name desc:(NSString *)desc url:(NSString *)url category:(NSString *)category language:(NSString *)language country:(NSString *)country __attribute__((swift_name("init(id:name:desc:url:category:language:country:)"))) __attribute__((objc_designated_initializer));
- (SharedSource_ *)doCopyId:(NSString *)id name:(NSString *)name desc:(NSString *)desc url:(NSString *)url category:(NSString *)category language:(NSString *)language country:(NSString *)country __attribute__((swift_name("doCopy(id:name:desc:url:category:language:country:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
+ (void)Skie_Suspend__6__fetchSourcesDispatchReceiver:(SharedSourcesUseCase *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__fetchSources(dispatchReceiver:suspendHandler:)")));
...
@property (class) SharedKoin_coreModule *articlesModule __attribute__((swift_name("articlesModule")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SourceModuleKt")))
@interface SharedSourceModuleKt : SharedBase
@property (class) SharedKoin_coreModule *sourceModule __attribute__((swift_name("sourceModule")));
@end
